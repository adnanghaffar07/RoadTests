...
public class Kembledev_Data {
	...
	public static String phoneNumber = "415 555 2671";
	public static String HomeAddress = "house # 1 USA";
	public static String ZipCode = "99501";
	public static String City = "Alaska";
	public static String State = "Alaska";
	public static String CardNumber = "5454545454545454";
	public static String CardExpirationDate = "122020";
	public static String CardExpirationDatePayinfo = "12/2020";
	public static String CardFullname = "Credit Card";
	public static String CVV = "121";
	public static String AuthCode = "121";
